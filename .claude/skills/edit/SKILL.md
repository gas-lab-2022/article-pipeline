...
```bash
SESSION_DIR="output/<domain>/$(date +%Y%m%d-%H%M%S)-edit-<slug>"
mkdir -p "$SESSION_DIR"
echo "$SESSION_DIR"
```

3. 出力されたパスを `sessionDir` として保持してください（例: `output/programming-zero.net/20260305-143000-edit-react-hooks-guide`）。
